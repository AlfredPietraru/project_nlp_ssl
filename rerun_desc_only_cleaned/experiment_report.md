...
- Dataset root: `cleaned_data`
- Running mode: `DESCRIPTION_ONLY`
- Merge `G/H -> F`: `False`
...
## Label Statistics
- Number of training examples after validation split: `1377`
- Difficulty counts: `[341, 311, 235, 229, 203, 37, 12, 9]`
- Number of tags: `35`
